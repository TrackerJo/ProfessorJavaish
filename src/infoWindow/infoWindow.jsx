...
function InfoWindow({closeInfoWinow}){
    ...
    return (
        ...
        <div className='InfoWindow'>
            <h1>What is Professor Java?</h1>
            <p>Professor Java is an IDE for a language that I wrote called Javaish. The whole goal of Prof. Java and Javaish is to create an easy way for beginners to see what programming is like, without the use of block coding. I tried to keep the language and IDE as simple as I could while not limiting the possibilities of what you could do too much.</p>
            <h1>Why was Professor Java and Javaish Made?</h1>
            ...
            <h1>How was Professor Java made?</h1>
